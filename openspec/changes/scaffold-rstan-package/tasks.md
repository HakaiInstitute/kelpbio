...
- [x] 1.3 Reconcile generated `DESCRIPTION` with the existing stub: keep the author/ORCID, set a real Title + Description, set a license (`usethis::use_mit_license()` — placeholder; switch to Apache-2.0 if preferred, per bboutools)
