...
Predicting from a fitted model: the rstantools generics (posterior_epred / posterior_linpred / posterior_predict / log_lik), kb_predict_weight(), the by / uncertainty axes, prior_summary(), and the kb_predictions object.
