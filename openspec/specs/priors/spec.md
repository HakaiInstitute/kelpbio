...
`kb_priors_weight_nereo()` SHALL return a named list of prior objects for the full *Nereocystis luetkeana* weight model with entries `intercept`, `diameter`, `diameter2`, `sd_site`, `sd_site_diameter`, `sd_site_year`, and `sd_residual`.
