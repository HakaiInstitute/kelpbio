...
test_that(".chk_progress_dir accepts NULL and an existing directory", {
  d <- withr::local_tempdir()
  expect_invisible(.chk_progress_dir(NULL))
  expect_identical(.chk_progress_dir(d), d)
})

test_that(".chk_progress_dir errors on a non-directory or non-string", {
...
test_that(".chk_sampler_args validates progress and progress_dir", {
