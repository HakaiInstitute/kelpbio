test_that("augment appends fitted and residual columns matching the methods", {
  ...
  # point estimates come straight from the methods' estimate column (no drift).
  expect_equal(a$fitted, fitted(weight_fit)$estimate)
  expect_equal(a$residual, residuals(weight_fit)$estimate)
})
