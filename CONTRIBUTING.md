# Contributing to kelpbio

This outlines how to propose a change to kelpbio.
...
Please note that the kelpbio project is released with a [Contributor
Code of Conduct](https://hakaiinstitute.github.io/CODE_OF_CONDUCT.md).
