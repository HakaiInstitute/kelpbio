...
assemble_weight_nereo_data <- function(
  ...
  list(
    ...
    prior_log_power_mu = priors$log_power$mean,
    prior_log_power_sd = priors$log_power$sd,
    prior_floor_shape1 = priors$floor$shape1,
    prior_floor_shape2 = priors$floor$shape2,
    prior_nu_shape = priors$nu$shape,
    prior_nu_rate = priors$nu$rate,
    prior_sd_site_rate = priors$sd_site$rate,
    prior_sd_year_rate = priors$sd_year$rate,
    prior_sd_site_power_rate = priors$sd_site_power$rate,
